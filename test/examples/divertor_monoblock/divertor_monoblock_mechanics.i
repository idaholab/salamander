# This input file extends divertor_monoblock_base.i to include mechanics.
...
youngs_modulus_W = 4.05e11 # ${units 4.05e11 Pa}
poissons_ratio_W = 2.80e-01
thermal_expansion_coeff_W = 1.41e-05
stress_free_temperature_W = 300
# https://www.mit.edu/~6.777/matprops/copper.htm
youngs_modulus_Cu = 1.30e11 #${units 1.30e11 Pa}
poissons_ratio_Cu = 0.34
thermal_expansion_coeff_Cu = 1.70e-05 # K^-1
stress_free_temperature_Cu = 300 #${units 300 K}
# https://www.sciencedirect.com/science/article/pii/S0920379619306349
# https://www.sciencedirect.com/science/article/pii/S0920379619307410 is a good source, I simplify it here
# http://www.conductivity-app.org/alloy-sheet/19
youngs_modulus_CuCrZr = 1.28e11 #${units 1.30e11 Pa}
poissons_ratio_CuCrZr = 0.3
thermal_expansion_coeff_CuCrZr = 1.70e-05 # K^-1
stress_free_temperature_CuCrZr = 300 #${units 300 K}
...
[BCs]
  ...
  [bottom_y]
    type = DirichletBC
    variable = disp_y
    boundary = 'pin pin2' #'pin pin2'
    value = 0
  []
  [bottom_z]
    type = DirichletBC
    variable = disp_z
    boundary = 'pin pin3' #'pin pin3'
    value = 0
  []
[]
