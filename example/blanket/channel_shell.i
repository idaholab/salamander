...
#mfr = 0.044 # kg/s, Scale from the numbers at Page 1037, thermohydraulics of rib-roughened helium gas running cooling channels for first wall applications
mfr = 0.132
...
[Components]
  ...
  [channel]
    type = FilePipe1Phase
    csv_file = 'channel_meshes/OB_shell1_channel01.csv'
    A = ${area}
    D_h = ${D_h}
    fp = h2
 #   roughness = ${roughness}
