...
registerMooseObject("SalamanderApp", FNSFHeatIC);
...
FNSFHeatIC::FNSFHeatIC(const InputParameters & parameters)
  : InitialCondition(parameters),
    ...
    _heat(getParam<std::vector<Real>>("heat"))
{
}

Real
FNSFHeatIC::value(const Point & p)
{
