...
echo "Running ${SCRIPT_DIR}/update_and_rebuild_salamander.sh..."
...
# Remove cardinal executable, not required for SALAMANDER build.
echo -e "${YELLOW}WARNING: Removing cardinal-${METHOD:-opt} since SALAMANDER will be built."
