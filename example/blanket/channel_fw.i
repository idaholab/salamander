...
mfr = 0.13267 # kg/s, Scale from the numbers at Page 1037, thermohydraulics of rib-roughened helium gas running cooling channels for first wall applications
...
[Components]
  ...
  [channel]
    type = FilePipe1Phase
    csv_file = 'channel_meshes/OB_FW_001.csv'
    A = ${area}
    D_h = ${D_h}
    fp = h2
    roughness = ${roughness}
