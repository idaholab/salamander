...
We preview below the results of the coupled neutronics and heat transfer model from this workflow in [tokamak_temperatures] and [tokamak_tritium_production] for the temperature distribution and tritium production rate density.

!row! style=display:inline-flex;
!col! small=12 medium=6 large=6 width=50%
...
| :- | :- | :- |
| Armor Max. Temperature          | $1062.4$                                   | `[K]`      |
| First Wall Max. Temperature   | $1057.6$                                   | `[K]`      |
| Breeder Max. Temperature        | $987.4$                                    | `[K]`      |
